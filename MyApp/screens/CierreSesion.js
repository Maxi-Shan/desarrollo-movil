        ...
        {/* <BlurView intensity={100}> */}
          ...
          <Image source={require('../assets/02.png')} style={styles.profilePicture}/>
            ...
            <View style={{ marginTop: 30 }}>
              <Text style={{fontSize: 24, fontWeight: 'bold', color: 'white'}}>Estas por cerrar sesion</Text>
            </View>

            <View style={{ marginTop: 20 }}>
              <Text style={{fontSize: 17, fontWeight: '400', color: 'white', textAlign: 'center' }}>¿Estas seguro que quieres cerrar sesion?</Text>
            </View>
            ...
            <TouchableOpacity style={[styles.buttom, {backgroundColor: '#BA68C8', marginTop: 50 }]} onPress={() => navigation.navigate('IniciarSesion')}
            >
              <Text style={{fontSize: 17, fontWeight: '400', color: 'white'}}>Cerrar Sesion</Text>
            </TouchableOpacity>
            <TouchableOpacity style={[styles.buttom, {backgroundColor: '#EF5350'}]}>
              <Text style={{fontSize: 17, fontWeight: '400', color: 'white'}}>Cancelar</Text>
            </TouchableOpacity>
